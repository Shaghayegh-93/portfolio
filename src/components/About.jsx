        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          ...
          <div>
            <p className="text-justify">
              ...
              data from APIs, and code based on websites’ design on
              Figma.<br/> I have worked on many projects using React.js and Next.js, and I
              know how to create effective, concise code while being able to
              keep up with tight deadlines and be adaptive with my responses to
              bugs and issues that arose.
